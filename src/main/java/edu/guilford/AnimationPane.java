...
public class AnimationPane extends Pane {
    ...
    //attributes for the size and the Scene where this will be displayed
    private int width;
    private int height;
    ...
    public AnimationPane(int width, int height) {
        ...
        Circle circle = new Circle(50, Color.FIREBRICK);
        ...
        ft.setCycleCount(4);
        // and we'll reverse it each time
        ...
        // Now we can build a PathTransition object with the circle as the target
        ...
        // Now we can build a Timeline object with the KeyFrames
        ...
        // and we play the sequence
        seqT.play();

        // Let's add a Circle to the Pane at a random location
        circEvent = new Circle(100, Color.FORESTGREEN);
    ...
    // inner class to animate the circle
    private class CircAnimate implements EventHandler<ActionEvent> {
        ...
        public void handle(ActionEvent arg0) {
            ...
            // check if the circle is near the edge of the pane, and if it is, reverse 
